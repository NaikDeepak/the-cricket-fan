...
| 2026-08-16 | Complete Cricsheet Multi-League Ingestion | Upgraded ingestion pipeline to fetch 28 competition archives (The Hundred Men & Women, WPL, WBBL, WT20I, T20 Blast, MLC, ILT20, LPL, BPL, etc.), normalized women's team names with canonical suffix, and synced 26,972 team-match rows (13,146 matches) across Neon Postgres & local SQLite. | PR to feature/mvp |

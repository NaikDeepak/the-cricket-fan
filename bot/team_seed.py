...
INITIAL_TEAMS = [
    ...
    # The Hundred (Women) — 2026 rebrand additions, mirrors the men's block.
    {
        ...
        "glow": "rgba(0, 188, 212, 0.4)",
        "text_dark": False,
        "aliases": ["srlw", "sunrisers leeds women"],
    },
    {
        "name": "MI London Women",
        "short_name": "MILW",
        "league": "The Hundred Women",
        "primary_color": "#004C93",
        "secondary_color": "#D1AB3E",
        "accent_color": "#D1AB3E",
        "gradient": "linear-gradient(135deg, #004C93 0%, #002B54 100%)",
        "glow": "rgba(209, 171, 62, 0.4)",
        "text_dark": False,
        "aliases": ["milw", "mi london women"],
    },
    # WBBL
    {
    ...
    # The Hundred (Men) — 2026 rebrand additions. Added alongside (not
    # replacing) the pre-rebrand names above so historical team_matches rows
    # under the old names still resolve for backtest across seasons.
    {
        "name": "Manchester Super Giants",
        "short_name": "MSG",
        "league": "The Hundred",
        "primary_color": "#1C1C1C",
        "secondary_color": "#666666",
        ...
        "glow": "rgba(229, 9, 20, 0.35)",
        "text_dark": False,
        "aliases": ["msg", "super giants", "manchester super giants"],
    },
    {
        "name": "Sunrisers Leeds",
        "short_name": "SRL",
        "league": "The Hundred",
        "primary_color": "#6A1B9A",
        "secondary_color": "#00BCD4",
